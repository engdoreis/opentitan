...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_LIB_MOCK_BOOT_POLICY_PTRS_H_
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_LIB_MOCK_BOOT_POLICY_PTRS_H_
...
#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_LIB_MOCK_BOOT_POLICY_PTRS_H_
