...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_LIB_BOOT_POLICY_H_
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_LIB_BOOT_POLICY_H_
...
#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_ROM_LIB_BOOT_POLICY_H_
