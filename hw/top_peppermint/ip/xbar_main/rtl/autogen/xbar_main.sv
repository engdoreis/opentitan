...
module xbar_main (
  ...
  tl_h2d_t tl_sm1_34_us_h2d [4];
  tl_d2h_t tl_sm1_34_us_d2h [4];
  ...
  tl_h2d_t tl_sm1_36_us_h2d [6];
  tl_d2h_t tl_sm1_36_us_d2h [6];
  ...
  tl_h2d_t tl_s1n_37_ds_h2d [26];
  tl_d2h_t tl_s1n_37_ds_d2h [26];
  ...
  tl_h2d_t tl_s1n_61_ds_h2d [24];
  tl_d2h_t tl_s1n_61_ds_d2h [24];
  ...
  tl_h2d_t tl_s1n_62_ds_h2d [3];
  tl_d2h_t tl_s1n_62_ds_d2h [3];

  // Create steering signal
  logic [1:0] dev_sel_s1n_62;
  ...
  assign tl_sm1_33_us_h2d[1] = tl_s1n_37_ds_h2d[1];
  assign tl_s1n_37_ds_d2h[1] = tl_sm1_33_us_d2h[1];

  assign tl_sm1_34_us_h2d[1] = tl_s1n_37_ds_h2d[2];
  assign tl_s1n_37_ds_d2h[2] = tl_sm1_34_us_d2h[1];

  assign tl_sm1_35_us_h2d[1] = tl_s1n_37_ds_h2d[3];
  assign tl_s1n_37_ds_d2h[3] = tl_sm1_35_us_d2h[1];

  assign tl_sm1_39_us_h2d[0] = tl_s1n_37_ds_h2d[4];
  assign tl_s1n_37_ds_d2h[4] = tl_sm1_39_us_d2h[0];

  assign tl_sm1_36_us_h2d[1] = tl_s1n_37_ds_h2d[5];
  assign tl_s1n_37_ds_d2h[5] = tl_sm1_36_us_d2h[1];

  assign tl_sm1_40_us_h2d[0] = tl_s1n_37_ds_h2d[6];
  assign tl_s1n_37_ds_d2h[6] = tl_sm1_40_us_d2h[0];

  assign tl_sm1_41_us_h2d[0] = tl_s1n_37_ds_h2d[7];
  assign tl_s1n_37_ds_d2h[7] = tl_sm1_41_us_d2h[0];

  assign tl_sm1_42_us_h2d[0] = tl_s1n_37_ds_h2d[8];
  assign tl_s1n_37_ds_d2h[8] = tl_sm1_42_us_d2h[0];

  assign tl_sm1_43_us_h2d[0] = tl_s1n_37_ds_h2d[9];
  assign tl_s1n_37_ds_d2h[9] = tl_sm1_43_us_d2h[0];

  assign tl_sm1_44_us_h2d[0] = tl_s1n_37_ds_h2d[10];
  assign tl_s1n_37_ds_d2h[10] = tl_sm1_44_us_d2h[0];

  assign tl_sm1_45_us_h2d[0] = tl_s1n_37_ds_h2d[11];
  assign tl_s1n_37_ds_d2h[11] = tl_sm1_45_us_d2h[0];

  assign tl_sm1_46_us_h2d[0] = tl_s1n_37_ds_h2d[12];
  assign tl_s1n_37_ds_d2h[12] = tl_sm1_46_us_d2h[0];

  assign tl_sm1_47_us_h2d[0] = tl_s1n_37_ds_h2d[13];
  assign tl_s1n_37_ds_d2h[13] = tl_sm1_47_us_d2h[0];

  assign tl_sm1_48_us_h2d[0] = tl_s1n_37_ds_h2d[14];
  assign tl_s1n_37_ds_d2h[14] = tl_sm1_48_us_d2h[0];

  assign tl_sm1_49_us_h2d[0] = tl_s1n_37_ds_h2d[15];
  assign tl_s1n_37_ds_d2h[15] = tl_sm1_49_us_d2h[0];

  assign tl_sm1_50_us_h2d[0] = tl_s1n_37_ds_h2d[16];
  assign tl_s1n_37_ds_d2h[16] = tl_sm1_50_us_d2h[0];

  assign tl_sm1_51_us_h2d[0] = tl_s1n_37_ds_h2d[17];
  assign tl_s1n_37_ds_d2h[17] = tl_sm1_51_us_d2h[0];

  assign tl_sm1_52_us_h2d[0] = tl_s1n_37_ds_h2d[18];
  assign tl_s1n_37_ds_d2h[18] = tl_sm1_52_us_d2h[0];

  assign tl_sm1_53_us_h2d[0] = tl_s1n_37_ds_h2d[19];
  assign tl_s1n_37_ds_d2h[19] = tl_sm1_53_us_d2h[0];

  assign tl_sm1_54_us_h2d[0] = tl_s1n_37_ds_h2d[20];
  assign tl_s1n_37_ds_d2h[20] = tl_sm1_54_us_d2h[0];

  assign tl_sm1_55_us_h2d[0] = tl_s1n_37_ds_h2d[21];
  assign tl_s1n_37_ds_d2h[21] = tl_sm1_55_us_d2h[0];

  assign tl_sm1_56_us_h2d[0] = tl_s1n_37_ds_h2d[22];
  assign tl_s1n_37_ds_d2h[22] = tl_sm1_56_us_d2h[0];

  assign tl_sm1_57_us_h2d[0] = tl_s1n_37_ds_h2d[23];
  assign tl_s1n_37_ds_d2h[23] = tl_sm1_57_us_d2h[0];

  assign tl_sm1_58_us_h2d[0] = tl_s1n_37_ds_h2d[24];
  assign tl_s1n_37_ds_d2h[24] = tl_sm1_58_us_d2h[0];

  assign tl_sm1_60_us_h2d[0] = tl_s1n_37_ds_h2d[25];
  assign tl_s1n_37_ds_d2h[25] = tl_sm1_60_us_d2h[0];

  assign tl_sm1_38_us_h2d[1] = tl_s1n_61_ds_h2d[0];
  assign tl_s1n_61_ds_d2h[0] = tl_sm1_38_us_d2h[1];

  assign tl_sm1_34_us_h2d[2] = tl_s1n_61_ds_h2d[1];
  assign tl_s1n_61_ds_d2h[1] = tl_sm1_34_us_d2h[2];

  assign tl_sm1_35_us_h2d[2] = tl_s1n_61_ds_h2d[2];
  assign tl_s1n_61_ds_d2h[2] = tl_sm1_35_us_d2h[2];

  assign tl_sm1_39_us_h2d[1] = tl_s1n_61_ds_h2d[3];
  assign tl_s1n_61_ds_d2h[3] = tl_sm1_39_us_d2h[1];

  assign tl_sm1_36_us_h2d[2] = tl_s1n_61_ds_h2d[4];
  assign tl_s1n_61_ds_d2h[4] = tl_sm1_36_us_d2h[2];

  assign tl_sm1_40_us_h2d[1] = tl_s1n_61_ds_h2d[5];
  assign tl_s1n_61_ds_d2h[5] = tl_sm1_40_us_d2h[1];

  assign tl_sm1_41_us_h2d[1] = tl_s1n_61_ds_h2d[6];
  assign tl_s1n_61_ds_d2h[6] = tl_sm1_41_us_d2h[1];

  assign tl_sm1_42_us_h2d[1] = tl_s1n_61_ds_h2d[7];
  assign tl_s1n_61_ds_d2h[7] = tl_sm1_42_us_d2h[1];

  assign tl_sm1_43_us_h2d[1] = tl_s1n_61_ds_h2d[8];
  assign tl_s1n_61_ds_d2h[8] = tl_sm1_43_us_d2h[1];

  assign tl_sm1_44_us_h2d[1] = tl_s1n_61_ds_h2d[9];
  assign tl_s1n_61_ds_d2h[9] = tl_sm1_44_us_d2h[1];

  assign tl_sm1_45_us_h2d[1] = tl_s1n_61_ds_h2d[10];
  assign tl_s1n_61_ds_d2h[10] = tl_sm1_45_us_d2h[1];

  assign tl_sm1_46_us_h2d[1] = tl_s1n_61_ds_h2d[11];
  assign tl_s1n_61_ds_d2h[11] = tl_sm1_46_us_d2h[1];
  ...
  assign tl_sm1_57_us_h2d[1] = tl_s1n_61_ds_h2d[21];
  assign tl_s1n_61_ds_d2h[21] = tl_sm1_57_us_d2h[1];

  assign tl_sm1_58_us_h2d[1] = tl_s1n_61_ds_h2d[22];
  assign tl_s1n_61_ds_d2h[22] = tl_sm1_58_us_d2h[1];

  assign tl_sm1_60_us_h2d[1] = tl_s1n_61_ds_h2d[23];
  assign tl_s1n_61_ds_d2h[23] = tl_sm1_60_us_d2h[1];

  assign tl_sm1_36_us_h2d[3] = tl_s1n_62_ds_h2d[0];
  assign tl_s1n_62_ds_d2h[0] = tl_sm1_36_us_d2h[3];

  assign tl_sm1_34_us_h2d[3] = tl_s1n_62_ds_h2d[1];
  assign tl_s1n_62_ds_d2h[1] = tl_sm1_34_us_d2h[3];

  assign tl_sm1_56_us_h2d[1] = tl_s1n_62_ds_h2d[2];
  assign tl_s1n_62_ds_d2h[2] = tl_sm1_56_us_d2h[1];

  assign tl_sm1_36_us_h2d[4] = tl_s1n_63_ds_h2d[0];
  assign tl_s1n_63_ds_d2h[0] = tl_sm1_36_us_d2h[4];

  assign tl_sm1_36_us_h2d[5] = tl_s1n_64_ds_h2d[0];
  assign tl_s1n_64_ds_d2h[0] = tl_sm1_36_us_d2h[5];
  ...
  assign tl_rv_dm__regs_o = tl_sm1_38_ds_h2d;
  assign tl_sm1_38_ds_d2h = tl_rv_dm__regs_i;

  assign tl_sram_ctrl_main__regs_o = tl_sm1_39_ds_h2d;
  assign tl_sm1_39_ds_d2h = tl_sram_ctrl_main__regs_i;

  assign tl_otp_ctrl__core_o = tl_sm1_40_ds_h2d;
  assign tl_sm1_40_ds_d2h = tl_otp_ctrl__core_i;

  assign tl_otp_macro__prim_o = tl_sm1_41_ds_h2d;
  assign tl_sm1_41_ds_d2h = tl_otp_macro__prim_i;

  assign tl_lc_ctrl__regs_o = tl_sm1_42_ds_h2d;
  assign tl_sm1_42_ds_d2h = tl_lc_ctrl__regs_i;

  assign tl_rv_plic_o = tl_sm1_43_ds_h2d;
  assign tl_sm1_43_ds_d2h = tl_rv_plic_i;

  assign tl_rv_timer_o = tl_sm1_44_ds_h2d;
  assign tl_sm1_44_ds_d2h = tl_rv_timer_i;

  assign tl_aes_o = tl_sm1_45_ds_h2d;
  assign tl_sm1_45_ds_d2h = tl_aes_i;

  assign tl_hmac_o = tl_sm1_46_ds_h2d;
  assign tl_sm1_46_ds_d2h = tl_hmac_i;

  assign tl_kmac_o = tl_sm1_47_ds_h2d;
  assign tl_sm1_47_ds_d2h = tl_kmac_i;

  assign tl_otbn_o = tl_sm1_48_ds_h2d;
  assign tl_sm1_48_ds_d2h = tl_otbn_i;

  assign tl_keymgr_dpe_o = tl_sm1_49_ds_h2d;
  assign tl_sm1_49_ds_d2h = tl_keymgr_dpe_i;

  assign tl_csrng_o = tl_sm1_50_ds_h2d;
  assign tl_sm1_50_ds_d2h = tl_csrng_i;

  assign tl_entropy_src_o = tl_sm1_51_ds_h2d;
  assign tl_sm1_51_ds_d2h = tl_entropy_src_i;
  ...
  assign tl_rv_core_ibex__cfg_o = tl_sm1_54_ds_h2d;
  assign tl_sm1_54_ds_d2h = tl_rv_core_ibex__cfg_i;
  ...
  assign tl_mbx1__core_o = tl_sm1_58_ds_h2d;
  assign tl_sm1_58_ds_d2h = tl_mbx1__core_i;

  assign tl_aon_o = tl_asf_59_ds_h2d;
  assign tl_asf_59_ds_d2h = tl_aon_i;
  ...
  assign tl_s1n_62_us_h2d = tl_dma__host_i;
  assign tl_dma__host_o = tl_s1n_62_us_d2h;

  assign tl_s1n_63_us_h2d = tl_mbx0__sram_i;
  assign tl_mbx0__sram_o = tl_s1n_63_us_d2h;

  assign tl_s1n_64_us_h2d = tl_mbx1__sram_i;
  assign tl_mbx1__sram_o = tl_s1n_64_us_d2h;
  ...
  always_comb begin
    ...
    end else if (((tl_s1n_32_us_h2d.a_address < (ADDR_SPACE_SRAM_CTRL_MAIN__RAM + ADDR_SIZE_SRAM_CTRL_MAIN__RAM)) &&
       (tl_s1n_32_us_h2d.a_address >= ADDR_SPACE_SRAM_CTRL_MAIN__RAM))) begin
      dev_sel_s1n_32 = 3'd3;
end
  end
  ...
  always_comb begin
    ...
    if ((tl_s1n_37_us_h2d.a_address &
      ...
      dev_sel_s1n_37 = 5'd24;
                  ...
                  ~(ADDR_MASK_AON)) == ADDR_SPACE_AON) begin
  ...
  always_comb begin
    ...
    end else if (((tl_s1n_61_us_h2d.a_address < (ADDR_SPACE_SRAM_CTRL_MAIN__RAM + ADDR_SIZE_SRAM_CTRL_MAIN__RAM)) &&
       (tl_s1n_61_us_h2d.a_address >= ADDR_SPACE_SRAM_CTRL_MAIN__RAM))) begin
      dev_sel_s1n_61 = 5'd4;
  ...
  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_62 = 2'd3;
    if (((tl_s1n_62_us_h2d.a_address < (ADDR_SPACE_SRAM_CTRL_MAIN__RAM + ADDR_SIZE_SRAM_CTRL_MAIN__RAM)) &&
  ...
  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_63 = 1'd1;
    if (((tl_s1n_63_us_h2d.a_address < (ADDR_SPACE_SRAM_CTRL_MAIN__RAM + ADDR_SIZE_SRAM_CTRL_MAIN__RAM)) &&
       (tl_s1n_63_us_h2d.a_address >= ADDR_SPACE_SRAM_CTRL_MAIN__RAM))) begin
      dev_sel_s1n_63 = 1'd0;
end
  end
  ...
  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_64 = 1'd1;
    if (((tl_s1n_64_us_h2d.a_address < (ADDR_SPACE_SRAM_CTRL_MAIN__RAM + ADDR_SIZE_SRAM_CTRL_MAIN__RAM)) &&
       (tl_s1n_64_us_h2d.a_address >= ADDR_SPACE_SRAM_CTRL_MAIN__RAM))) begin
      dev_sel_s1n_64 = 1'd0;
end
  end
