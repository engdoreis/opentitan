...
<!-- BEGIN CMDGEN util/regtool.py -d ./hw/top_peppermint/ip_autogen/pwrmgr/data/pwrmgr.hjson -->
## Summary
...
```wavejson
{"reg": [{"name": "LOW_POWER_HINT", "bits": 1, "attr": ["rw"], "rotate": -90}, {"bits": 3}, {"name": "CORE_CLK_EN", "bits": 1, "attr": ["rw"], "rotate": -90}, {"name": "MAIN_PD_N", "bits": 1, "attr": ["rw"], "rotate": -90}, {"bits": 26}], "config": {"lanes": 1, "fontsize": 10, "vspace": 160}}
```

|  Bits  |  Type  |  Reset  | Name                                       |
|:------:|:------:|:-------:|:-------------------------------------------|
|  31:6  |        |         | Reserved                                   |
|   5    |   rw   |   0x1   | [MAIN_PD_N](#control--main_pd_n)           |
...
|:------:|:------:|:-------:|:-------|:-------------------------------|
|  31:1  |        |         |        | Reserved                       |
|   0    |   rw   |   0x1   | EN_0   | Reset enable for soc: rst_req. |
...
```wavejson
{"reg": [{"name": "REASONS", "bits": 1, "attr": ["rw1c"], "rotate": -90}, {"name": "FALL_THROUGH", "bits": 1, "attr": ["rw1c"], "rotate": -90}, {"name": "ABORT", "bits": 1, "attr": ["rw1c"], "rotate": -90}, {"bits": 29}], "config": {"lanes": 1, "fontsize": 10, "vspace": 140}}
```

|  Bits  |  Type  |  Reset  | Name                                     |
|:------:|:------:|:-------:|:-----------------------------------------|
|  31:3  |        |         | Reserved                                 |
|   2    |  rw1c  |   0x0   | [ABORT](#wake_info--abort)               |
|   1    |  rw1c  |   0x0   | [FALL_THROUGH](#wake_info--fall_through) |
|   0    |  rw1c  |   0x0   | [REASONS](#wake_info--reasons)           |
