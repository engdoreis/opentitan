...
module clkmgr_reg_top (
  ...
  logic [29:0] main_meas_ctrl_shadowed_qs;
  ...
  logic [14:0]  main_main_meas_ctrl_shadowed_hi_qs_int;
  logic [14:0]  main_main_meas_ctrl_shadowed_lo_qs_int;
  logic [29:0] main_main_meas_ctrl_shadowed_qs;
  logic [29:0] main_main_meas_ctrl_shadowed_wdata;
  ...
  always_comb begin
    main_main_meas_ctrl_shadowed_qs = 30'h17d2afb9;
    main_main_meas_ctrl_shadowed_qs[14:0] = main_main_meas_ctrl_shadowed_hi_qs_int;
    main_main_meas_ctrl_shadowed_qs[29:15] = main_main_meas_ctrl_shadowed_lo_qs_int;
  end

  prim_reg_cdc #(
    .DataWidth(30),
    .ResetVal(30'h17d2afb9),
    .BitMask(30'h3fffffff),
    .DstWrReq(0)
  ...
  prim_subreg_shadow #(
    ...
    .wd     (main_main_meas_ctrl_shadowed_wdata[14:0]),
  ...
  prim_subreg_shadow #(
    ...
    .re     (main_main_meas_ctrl_shadowed_re),
    .we     (main_main_meas_ctrl_shadowed_gated_we),
    .wd     (main_main_meas_ctrl_shadowed_wdata[29:15]),
  ...
  always_comb begin
    ...
    addr_hit[3] = (reg_addr == CLKMGR_MEASURE_CTRL_REGWEN_OFFSET);
    addr_hit[4] = (reg_addr == CLKMGR_MAIN_MEAS_CTRL_EN_OFFSET);
    addr_hit[5] = (reg_addr == CLKMGR_MAIN_MEAS_CTRL_SHADOWED_OFFSET);
    addr_hit[6] = (reg_addr == CLKMGR_RECOV_ERR_CODE_OFFSET);
    addr_hit[7] = (reg_addr == CLKMGR_FATAL_ERR_CODE_OFFSET);
  end
  ...
  assign measure_ctrl_regwen_we = addr_hit[3] & reg_we & !reg_error;

  assign measure_ctrl_regwen_wd = reg_wdata[0];
  assign main_meas_ctrl_en_we = addr_hit[4] & reg_we & !reg_error;

  assign main_meas_ctrl_shadowed_re = addr_hit[5] & reg_re & !reg_error;
  assign main_meas_ctrl_shadowed_we = addr_hit[5] & reg_we & !reg_error;


  assign recov_err_code_we = addr_hit[6] & reg_we & !reg_error;

  assign recov_err_code_shadow_update_err_wd = reg_wdata[0];

  assign recov_err_code_main_measure_err_wd = reg_wdata[1];

  assign recov_err_code_main_timeout_err_wd = reg_wdata[2];
  ...
  always_comb begin
    ...
    reg_we_check[3] = measure_ctrl_regwen_we;
    reg_we_check[4] = main_meas_ctrl_en_we;
    reg_we_check[5] = main_meas_ctrl_shadowed_we;
    reg_we_check[6] = recov_err_code_we;
    reg_we_check[7] = 1'b0;
  end
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[6]: begin
        ...
        reg_rdata_next[1] = recov_err_code_main_measure_err_qs;
        reg_rdata_next[2] = recov_err_code_main_timeout_err_qs;
      end
