...
package clkmgr_env_pkg;
  ...
  // parameters
  parameter int NUM_PERI = 0;
  parameter int NUM_TRANS = 0;

  typedef logic [0:0] peri_enables_t;
  typedef logic [0:0] hintables_t;
  typedef mubi4_t [0:0] mubi_hintables_t;
  parameter mubi_hintables_t IdleAllBusy = {1{prim_mubi_pkg::MuBi4False}};

  parameter int MainClkHz = 400_000_000;
  parameter int AonClkHz = 32_768;
