...
interface rstmgr_cascading_sva_if (
  ...
  `CASCADED_ASSERTS(CascadeEffAonToRstPorMain, effective_aon_rst_n[rstmgr_pkg::DomainAonSel],
                    resets_o.rst_por_main_n[rstmgr_pkg::DomainAonSel], SyncCycles, clk_main_i)
  ...
  `CASCADED_ASSERTS(CascadeLcToLc, rst_lc_src_n[rstmgr_pkg::DomainMainSel],
                    resets_o.rst_lc_main_n[rstmgr_pkg::DomainMainSel], SysCycles, clk_main_i)
  ...
  `CASCADED_ASSERTS(CascadeLcToLcShadowed, rst_lc_src_n[rstmgr_pkg::DomainMainSel],
                    resets_o.rst_lc_main_shadowed_n[rstmgr_pkg::DomainMainSel], SysCycles, clk_main_i)
