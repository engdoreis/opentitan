...
module tb;
  ...
  tl_if tl_if (
    .clk,
    .rst_n(rstmgr_if.resets_o.rst_lc_main_n[rstmgr_pkg::DomainMainSel])
  );
  ...
  rstmgr dut (
    .clk_i        (clk),
    .rst_ni       (rstmgr_if.resets_o.rst_lc_main_n[rstmgr_pkg::DomainMainSel]),
    .clk_aon_i    (clk_aon),
    .clk_main_i   (clk_main),
    .clk_por_i    (clk_main),
    .rst_por_ni   (rstmgr_if.resets_o.rst_por_main_n[rstmgr_pkg::DomainAonSel]),
  ...
  initial begin
    ...
    force clk_rst_if.rst_n = rstmgr_if.resets_o.rst_lc_main_n[rstmgr_pkg::DomainMainSel];
  end
