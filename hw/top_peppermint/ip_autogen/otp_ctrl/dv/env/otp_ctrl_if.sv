...
interface otp_ctrl_if(input clk_i, input rst_ni);
  ...
  import cip_base_pkg::*;
  import top_peppermint_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault;
  ...
  task automatic force_sw_check_fail(
    ...
    if (fail_idx[RotFirmwareAuthSlot0Idx]) begin
      force tb.dut.gen_partitions[RotFirmwareAuthSlot0Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot0Idx] = 1;
    end
    if (fail_idx[RotFirmwareAuthSlot1Idx]) begin
      force tb.dut.gen_partitions[RotFirmwareAuthSlot1Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot1Idx] = 1;
    end
    if (fail_idx[RotFirmwareAuthSlot2Idx]) begin
      force tb.dut.gen_partitions[RotFirmwareAuthSlot2Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot2Idx] = 1;
    end
    if (fail_idx[RotFirmwareAuthSlot3Idx]) begin
      force tb.dut.gen_partitions[RotFirmwareAuthSlot3Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot3Idx] = 1;
    end
    if (fail_idx[SocFirmwareAuthSlot0Idx]) begin
      force tb.dut.gen_partitions[SocFirmwareAuthSlot0Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot0Idx] = 1;
    end
    if (fail_idx[SocFirmwareAuthSlot1Idx]) begin
      force tb.dut.gen_partitions[SocFirmwareAuthSlot1Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot1Idx] = 1;
    end
    if (fail_idx[SocFirmwareAuthSlot2Idx]) begin
      force tb.dut.gen_partitions[SocFirmwareAuthSlot2Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot2Idx] = 1;
    end
    if (fail_idx[SocFirmwareAuthSlot3Idx]) begin
      force tb.dut.gen_partitions[SocFirmwareAuthSlot3Idx].gen_unbuffered.
            u_part_unbuf.`ECC_REG_PATH.data_i[0] = 1;
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot3Idx] = 1;
    end
  endtask
  ...
  task automatic release_sw_check_fail();
    ...
    if (force_sw_parts_ecc_reg[RotFirmwareAuthSlot0Idx]) begin
      release tb.dut.gen_partitions[RotFirmwareAuthSlot0Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot0Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[RotFirmwareAuthSlot1Idx]) begin
      release tb.dut.gen_partitions[RotFirmwareAuthSlot1Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot1Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[RotFirmwareAuthSlot2Idx]) begin
      release tb.dut.gen_partitions[RotFirmwareAuthSlot2Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot2Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[RotFirmwareAuthSlot3Idx]) begin
      release tb.dut.gen_partitions[RotFirmwareAuthSlot3Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[RotFirmwareAuthSlot3Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[SocFirmwareAuthSlot0Idx]) begin
      release tb.dut.gen_partitions[SocFirmwareAuthSlot0Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot0Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[SocFirmwareAuthSlot1Idx]) begin
      release tb.dut.gen_partitions[SocFirmwareAuthSlot1Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot1Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[SocFirmwareAuthSlot2Idx]) begin
      release tb.dut.gen_partitions[SocFirmwareAuthSlot2Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot2Idx] = 0;
    end
    if (force_sw_parts_ecc_reg[SocFirmwareAuthSlot3Idx]) begin
      release tb.dut.gen_partitions[SocFirmwareAuthSlot3Idx].gen_unbuffered.
              u_part_unbuf.`ECC_REG_PATH.data_i[0];
      force_sw_parts_ecc_reg[SocFirmwareAuthSlot3Idx] = 0;
    end
  endtask
  ...
  task automatic force_part_access_mubi(otp_part_access_lock_t forced_part_access_sel[NumPart-1]);
    ...
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(AuthSlotStateIdx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(RotCreatorAuthIdx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(RotFirmwareAuthSlot0Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(RotFirmwareAuthSlot1Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(RotFirmwareAuthSlot2Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(RotFirmwareAuthSlot3Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(SocFirmwareAuthSlot0Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(SocFirmwareAuthSlot1Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(SocFirmwareAuthSlot2Idx)
    `FORCE_OTP_PART_LOCK_WITH_RAND_NON_MUBI_VAL(SocFirmwareAuthSlot3Idx)
