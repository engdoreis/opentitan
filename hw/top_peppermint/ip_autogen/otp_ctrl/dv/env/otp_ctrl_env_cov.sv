  ...
  covergroup csr_rd_after_alert_cg(otp_ctrl_core_reg_block ral) with function sample(bit[TL_DW-1:0]
    ...
    read_csr_after_alert_issued: coverpoint csr_offset {
      bins unbuffered_digests  = {
        ...
        ral.rot_firmware_auth_slot1_digest[1].get_offset(),
        ral.rot_firmware_auth_slot2_digest[0].get_offset(),
        ral.rot_firmware_auth_slot2_digest[1].get_offset(),
        ral.rot_firmware_auth_slot3_digest[0].get_offset(),
        ral.rot_firmware_auth_slot3_digest[1].get_offset(),
        ral.soc_firmware_auth_slot0_digest[0].get_offset(),
        ral.soc_firmware_auth_slot0_digest[1].get_offset(),
        ral.soc_firmware_auth_slot1_digest[0].get_offset(),
        ral.soc_firmware_auth_slot1_digest[1].get_offset(),
        ral.soc_firmware_auth_slot2_digest[0].get_offset(),
        ral.soc_firmware_auth_slot2_digest[1].get_offset(),
        ral.soc_firmware_auth_slot3_digest[0].get_offset(),
        ral.soc_firmware_auth_slot3_digest[1].get_offset()
      };
      bins hw_digests          = {
...
class otp_ctrl_env_cov extends cip_base_env_cov #(.CFG_T(otp_ctrl_env_cfg));
  ...
  covergroup dai_err_code_cg with function sample(bit [TL_DW-1:0] val, int part_idx);
    ...
    partition: coverpoint part_idx {
      ...
      bins rot_firmware_auth_slot3 = {RotFirmwareAuthSlot3Idx};
      bins soc_firmware_auth_slot0 = {SocFirmwareAuthSlot0Idx};
      bins soc_firmware_auth_slot1 = {SocFirmwareAuthSlot1Idx};
      bins soc_firmware_auth_slot2 = {SocFirmwareAuthSlot2Idx};
      bins soc_firmware_auth_slot3 = {SocFirmwareAuthSlot3Idx};
