...
package otp_ctrl_env_pkg;
  ...
  parameter int PART_BASE_ADDRS [NumPart-1] = {
    ...
    RotFirmwareAuthSlot3Offset,
    SocFirmwareAuthSlot0Offset,
    SocFirmwareAuthSlot1Offset,
    SocFirmwareAuthSlot2Offset,
    SocFirmwareAuthSlot3Offset,
    ExtNvmOffset,
    HwCfg0Offset,
    HwCfg1Offset,
    Secret0Offset,
  ...
  parameter int PART_OTP_DIGEST_ADDRS [NumPart-1] = {
    ...
    RotFirmwareAuthSlot3DigestOffset >> 2,
    SocFirmwareAuthSlot0DigestOffset >> 2,
    SocFirmwareAuthSlot1DigestOffset >> 2,
    SocFirmwareAuthSlot2DigestOffset >> 2,
    SocFirmwareAuthSlot3DigestOffset >> 2,
    -1, // This partition does not have a digest.
